  ...
  switch (event.httpMethod) {
    case 'GET':
      ...
      if (segments.length === 0) {
        return __webpack_require__(1).handler(event, context);
      } // e.g. GET /.netlify/functions/customers/123456


      if (segments.length === 1) {
        event.id = segments[0];
        return __webpack_require__(94).handler(event, context);
      } else {
        return {
          statusCode: 500,
          body: 'too many segments in GET request, must be either /.netlify/functions/customers or /.netlify/functions/customers/123456'
        };
      }

    case 'POST':
      // e.g. POST /.netlify/functions/customers with a body of key value pair objects, NOT strings
      return __webpack_require__(95).handler(event, context);
    ...
    case 'PUT':
      ...
      if (segments.length === 1) {
        ...
        return __webpack_require__(96).handler(event, context);
      } else {
        return {
          statusCode: 500,
          body: 'invalid segments in POST request, must be /.netlify/functions/customers/123456'
        };
      }
    ...
    case 'DELETE':
      ...
      if (segments.length === 1) {
        event.id = segments[0];
        return __webpack_require__(97).handler(event, context);
      } else {
        return {
          statusCode: 500,
          body: 'invalid segments in DELETE request, must be /.netlify/functions/customers/123456'
        };
      }
    ...
    case 'OPTIONS':
      ...
      return {
        statusCode: 200,
        // <-- Must be 200 otherwise pre-flight call fails
        headers,
...
const faunadb = __webpack_require__(6);
...
exports.handler = async (event, context) => {
  ...
  return client.query(q.Paginate(q.Match(q.Ref('indexes/all_customers')))).then(response => {
...
module.exports = {
  ...
  Expr: __webpack_require__(84),
  PageHelper: __webpack_require__(91),
  RequestResult: __webpack_require__(89),

  clientLogger: __webpack_require__(93),
  errors: __webpack_require__(80),
...
var btoa = __webpack_require__(8);
...
var RequestResult = __webpack_require__(89);
var util = __webpack_require__(90);
var PageHelper = __webpack_require__(91);
...
const debug = __webpack_require__(10)('superagent');
const formidable = __webpack_require__(19);
const FormData = __webpack_require__(22);
const Response = __webpack_require__(43);
const parse = __webpack_require__(28).parse;
const format = __webpack_require__(28).format;
const resolve = __webpack_require__(28).resolve;
let methods = __webpack_require__(46);
const Stream = __webpack_require__(24);
const utils = __webpack_require__(45);
const unzip = __webpack_require__(47).unzip;
const extend = __webpack_require__(50);
...
exports.agent = __webpack_require__(73);
...
var IncomingForm = __webpack_require__(20).IncomingForm;
...
var require;if (global.GENTLY) require = GENTLY.hijack(__webpack_require__(21));
...
mime.define(__webpack_require__(52));
...
var getSideChannel = __webpack_require__(55);
...
var callBound = __webpack_require__(62);
...
var utilInspect = __webpack_require__(65);
...
const AgentBase = __webpack_require__(74);
let methods = __webpack_require__(46);
...
exports['application/x-www-form-urlencoded'] = __webpack_require__(76);
exports['application/json'] = __webpack_require__(77);
exports.text = __webpack_require__(78);

const binary = __webpack_require__(79);
...
var annotate = __webpack_require__(82);
var deprecate = __webpack_require__(83);
var Expr = __webpack_require__(84);
var errors = __webpack_require__(80);
var values = __webpack_require__(85);
...
exports.handler = async (event, context) => {
  ...
  return client.query(q.Get(q.Ref(`classes/customers/${id}`))).then(response => {
...
exports.handler = async (event, context) => {
  ...
  return client.query(q.Update(q.Ref('classes/customers'), item)).then(response => {
    console.log('success', response);
    /* Success! return the response with statusCode 200 */
...
exports.handler = async (event, context) => {
  ...
  return client.query(q.Delete(q.Ref(`classes/customers/${id}`))).then(response => {
    console.log('success', response);
    return {
      statusCode: 200,
      body: JSON.stringify(response)
